...
import FAQ from "./ui/faq/question";
...
export default function Home() {
    return (
        <main className="">
            ...
            <div className="my-20 ">
                <h2 className="md:text-4xl text-2xl font-bold">What is ACE</h2>
                <p className="md:text-lg text-sm text-justify">
                    ACE atau Assa&apos;adah Campus Expo merupakan sebuah acara
                    campus expo yang diadakan oleh IKBAL yang bertujuan untuk
                    memberikan gambaran kepada siswa-siswa SMA, MA, dan SMK
                    Assa&apos;adah menganai kampus-kampus yang ada di Indonesia.
                    Dengan adanya acara ini, diharapkan siswa-siswa dapat
                    mengetahui kampus yang sesuai dengan minat dan bakat mereka.
                    Acara ini juga bertujuan untuk memberikan gambaran kepada
                    siswa-siswa mengenai dunia perkuliahan yang sesungguhnya,
                    sehingga siswa-siswa dapat mempersiapkan diri sebelum
            ...
            <div className="my-10">
                ...
                <div className="md:grid md:grid-cols-3 flex flex-col">
                    <div className="bg-olive p-10">
                        ...
                        <p>
                            Pengisian materi tenang berbagai hal yang
                            berhubungan dengan perkuliahan, seminar ini diisi
                            oleh para alumni yang berkuliah di berbagai kampus
                    ...
                    <div className="bg-sagegreen p-10">
                        ...
                        <p>
                            Pameran yang diisi oleh berbagai kampus yang ada di
                            Indonesia, Para siswa bisa menanyakan tentang
                            perkuliahan dengan lebih dekat pada kampus tujuan
                            mereka
                        </p>
                    </div>
                    <div className="bg-olive p-10">
                        ...
                        <p>
                            Seminar yang akan diisi oleh para alumni yang
                            berkuliah di berbagai kampus yang ada di Indonesia
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div>
                <h2 className="text-2xl font-bold text-center pt-10 pb-4">
                    Roundown
                </h2>
